<?php 
  ...
  $emailUsuario = $session_youtube['emailUsuario'];
              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?php echo site_url('assetsadm/img/user3-128x128.jpg'); ?>" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?php echo site_url('assetsadm/img/user4-128x128.jpg'); ?>" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  ...
                  <small>Membro desde <?php echo $dataCadastro."<br>" .$emailUsuario; ?></small>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
